...
import { pluginKey as typeAheadPluginKey, PluginState as TypeAheadPluginState } from './main'
...
export function inputRulePlugin(
  ...
  const typeAheadInputRule = createInputRule(regex, (state, match) => {
    const typeAheadState = typeAheadPluginKey.getState(state) as TypeAheadPluginState
